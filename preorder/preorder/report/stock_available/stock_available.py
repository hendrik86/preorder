...
def get_columns():
	return [_("Item Code") + ":Link/Item:140", _("Item Name") + "::100", _("Description") + "::200",
		...
		_("UOM") + ":Link/UOM:100", _("Warehouse Stock") + ":Float:110", _("Planned Qty") + ":Float:100",
		_("Requested Qty") + ":Float:110", _("Indent Qty") + ":Float:100",
		_("Booking Qty") + ":Float:100", _("Reserved Qty for Production") + ":Float:100",
		_("Available Qty") + ":Float:100", _("Reorder Level") + ":Float:100", _("Reorder Qty") + ":Float:100",
